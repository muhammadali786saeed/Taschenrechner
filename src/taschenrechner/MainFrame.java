...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		var_btn_mplus.setToolTipText("im Speicher addieren");
		...
		var_btn_mminus.setToolTipText("Subtrahieren vom Speicher");
		...
		var_btn_mclear.setToolTipText("Speicher löschen (M)");
		...
		var_btn_m.setToolTipText("Benutzung des Speichers ");
